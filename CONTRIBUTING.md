...
Welcome to `lmi-solver` contributor's guide.
...
If you experience bugs or general issues with `lmi-solver`, please have a look
...
You can help improve `lmi-solver` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`lmi-solver` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `lmi-solver`'s files. While this mechanism can
...
```
conda create -n lmi-solver python=3 six virtualenv pytest pytest-cov
conda activate lmi-solver
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/lmi-solver.git
   cd lmi-solver
   ```
...
5. Install [pre-commit]:
   ...
   `lmi-solver` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/lmi-solver
[issue tracker]: https://github.com/<USERNAME>/lmi-solver/issues
